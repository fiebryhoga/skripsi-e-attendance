            ...
            <div class="lg:col-span-2">
                <div class="bg-white p-8 rounded-3xl shadow-xl shadow-gray-100/50 border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="phone_parent" value="{{ old('phone_parent', $student->phone_parent) }}" placeholder="812xxxxx" 
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-100 flex justify-end gap-3">
                        <a href="{{ route('admin.students.index') }}" class="px-6 py-3 rounded-xl bg-gray-100 text-gray-600 font-semibold hover:bg-gray-200 transition-colors">Batal</a>

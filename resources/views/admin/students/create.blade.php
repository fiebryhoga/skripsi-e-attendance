                            ...
                            <div>
                                ...
                                @if($classrooms->isEmpty())
                                    <p class="text-xs text-red-500 mt-2 italic">
                                        * Belum ada data kelas. Silakan buat kelas terlebih dahulu di menu Data Kelas.
                                    </p>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white p-6 md:p-8 rounded-3xl shadow-xl shadow-gray-100/50 border border-gray-100"> 
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="col-span-1 md:col-span-2"> 
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="phone_parent" placeholder="0812xxxxx" 
                            ...
                            <div class="mt-8 pt-6 border-t border-gray-100 flex flex-col md:flex-row justify-end gap-3"> 
                                <button type="reset" class="w-full md:w-auto px-6 py-3 rounded-xl bg-gray-100 text-gray-600 font-semibold hover:bg-gray-200 transition-colors">Reset</button>

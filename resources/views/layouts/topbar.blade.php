            ...
            <div class="relative" 
                ...
                <button @click="open = !open; if(open) markAsRead()" class="relative p-2.5 text-gray-400 hover:text-indigo-600 transition-all rounded-full hover:bg-indigo-50 focus:outline-none">
                    ...
                    <template x-if="unreadCount > 0">
                        <span class="absolute top-1.5 right-1.5 flex items-center justify-center min-w-[18px] h-[18px] px-1 text-[10px] font-bold text-white bg-red-500 rounded-full ring-2 ring-white animate-pulse" x-text="unreadCount">
                        </span>
                    </template>
                ...
                <div x-show="open" @click.away="open = false" style="display: none;"
                     ...
                     class="absolute right-0 mt-3 w-80 sm:w-96 bg-white rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden z-50">
                    ...
                    <div class="bg-gray-50 p-3 text-center border-t border-gray-100">
                        <a href="#" class="text-xs font-bold text-indigo-600 hover:text-indigo-700 hover:underline">Lihat Semua Notifikasi</a>
                    </div>
                    @endif
                </div>
            </div>
